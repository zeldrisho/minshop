...
- **70 test files**, organized as colocated `foo.ts` + `foo.test.ts` throughout the codebase, plus centralized directories including `tests/storefront` and `tests/integration`.
