...
- [ ] Commit docs migration (`CUSTOMIZING.md` -> `docs/customizing.md`, `docs/*.md` untracked)
- [ ] Clean fork metadata (`README` badges/deploy URL, `package.json` repo URLs) if needed
