 ...
 * Written by scripts/theme/theme-css.mjs. One of these exists per theme; the
...
function themeTsconfig(id) {
  return `${JSON.stringify(
    {
      $comment: `GENERATED by scripts/theme/theme-css.mjs — selects theme: ${id}. Do not edit or commit. Consumed via astro check --tsconfig.`,
...
function sharedTsconfig(id) {
  return `${JSON.stringify(
    {
      $comment: `GENERATED by scripts/theme/theme-css.mjs from ${CONFIG_FILE} — theme: ${id}. Do not edit or commit.`,
      compilerOptions: { paths: { "#theme/*": [`./${THEMES_DIR}/${id}/*`] } },
    },
    null,
    2,
...
export function writeThemeArtifacts(root = process.cwd()) {
  ...
  writeIfChanged(
    ...
    `/*
 * GENERATED — do not edit, and do not commit.
 * Written by scripts/theme/theme-css.mjs for src/styles/admin.css: keeps every
